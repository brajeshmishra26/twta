...
mysqli_set_charset($link,'utf8');
                                  ...
                                  if(isset($_REQUEST["verify"])){
                                   ...
                                   $sqlotp="SELECT * FROM affiliate WHERE affiliate_ID=$id";
      ...
      {
                                                    $sqlflag = "update affiliate set flag = 1 where affiliate_ID = $id";
                    if (mysqli_query($link,$sqlflag)) {
                        
                                                echo "<script type='text/javascript'>alert(\"Mobile Number Verified... \");window.location.href = '../profile.php';</script>";
        ...
        <div class="login-container text-c animated flipInX">
                ...
                <div class="container-content">
                    <form class="margin-t">
                        ...
                        <a class="text-darkyellow" href="/myVita/mlm/club/otp"><small>Resend OTP</small></a>
                        <!--<p class="text-whitesmoke text-center"><small>Do not have an account?</small></p>-->
                        <!--<a class="text-darkyellow" href="#"><small>Sign Up</small></a>-->
                    </form>
                    <p class="margin-t text-whitesmoke"><small> myVita &copy; 2020</small> </p>
                </div>
            </div>
</body>
<!-- partial -->
