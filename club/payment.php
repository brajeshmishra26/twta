...
if (isset($_SESSION["wid"])) {
    ...
    if (isset($_REQUEST["gender"], $_REQUEST["address"], $_REQUEST["city"])) {
        ...
        $stmt2 = mysqli_prepare($link, "UPDATE writer SET email = ?, address = ?, cityid = ?, gender = ? WHERE wid = ?");
        if ($stmt2) {
            mysqli_stmt_bind_param($stmt2, 'ssssi', $email, $address, $city, $gender, $id);
            if (mysqli_stmt_execute($stmt2)) {
                echo "<script type='text/javascript'>alert('Profile Updated...');window.location.href='workprofile.php';</script>";
            } else {
...
<strong style="font-size:15px"><b>Scan Below QR Code And Make Payment of Rs 300<br>After Making Payment Whatsapp Reciept To 7987117762 </b></strong>
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <img src="images/qrcode.jpg" class="responsive">
                                            ...
                                            <!--<form id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="name" name="name" value="<?php echo $bb["name"]; ?>"  required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" id="contact" name="contact" value="<?php echo $bb["contact"]; ?>" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                                                    </div>
                                                </div>
                                                <div class="form-group">
