                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					  ...
					  <?php  
								...
								$i = 0;	
								$b = mysqli_query("select * from writer");
					  ...
					  ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $bb["email"] ?></td>
                           <!--<td><?php echo $bb["dist"] ?></td>-->
                          <td><a style="color:orangered; font-weight:bold;" href="network.php?wid=<?php echo $bb["wid"]?>">Detail</a></td>
                        </tr>
					...
					<?php 
						...
						if(isset($_REQUEST["wid"])){
							...
							if(mysqli_query("update writer set flag = 1 where wid = $wid")){
								?>
										<script>window.location.href="network.php"; </script>
								<?php
							}
