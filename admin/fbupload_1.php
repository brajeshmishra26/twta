...
if (isset($_SESSION["id"])) {
    ...
    <html lang="en">
        <head>
            ...
            <title>Achievement Upload </title>
                                            ...
                                            <form id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea id="headline" name="headline"  required="required" class="form-control col-md-7 col-xs-12" rows="2"></textarea>
    ...
    if (isset($_REQUEST["headline"])) {
        ...
        if (!is_dir('fbimg')) { @mkdir('fbimg', 0755, true); }
        if (isset($_FILES['photo']) && is_uploaded_file($_FILES['photo']['tmp_name'])) {
            ...
            if ($size > 0 && $size <= $maxSize && in_array($ext, $allowedExt, true) && in_array($mime, $allowedMime, true)) {
                ...
                if (move_uploaded_file($tmp, 'fbimg/' . $safe)) {
                    $stmt = mysqli_prepare($link, "INSERT INTO uparticle (image, date, headline, cid) VALUES (?, ?, ?, 2)");
                    if ($stmt) {
                        mysqli_stmt_bind_param($stmt, 'sss', $safe, $date, $headline);
                        if (mysqli_stmt_execute($stmt)) {
                            ?>
                                            <script type="text/javascript">
                                                alert("Content Uploaded");
                                                window.location.href = "fbupload_1.php";
                                            </script>
                            <?php
                        }
