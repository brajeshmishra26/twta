...
if (isset($_SESSION["id"])){
    ...
    <html lang="en">
        <head>
            ...
            <title>Writer's Club - Submitted Topics </title>
                                        ...
                                        <div class="x_content">
                                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $i = 0;
                                                    $date = date("Y-m-d");
                                                    $b = mysqli_query("select writer.*, warticle.* from warticle inner join writer on (writer.wid = warticle.wid) inner join topicassign on (topicassign.taid = warticle.taid)  where topicassign.cityid = $cid and warticle.date = '$date' order by waid desc");
                                                    while ($bb = mysqli_fetch_array($b)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                    <?php
                                                                    $d = mysqli_query("select * from apparticle where waid = " . $bb['waid']);
                                                                    if ($dd = mysqli_fetch_array($d)) {
                                                                        ?>
                                                                        <span class="btn btn-success">Published</span>
                                                                    <?php
                                                                    } else {
                                                                    ?>
                                                                        <form action="submittedtopics.php"> 
                                                                            <input type="hidden" name="cid" value="<?php echo $cid; ?>" />
                                                                            <input type="hidden" name="waid" value="<?php echo $bb['waid']; ?>" />  <button type="submit" class="btn btn-danger">Publish</button></form>
													...
													?>
																<script>
																	window.location.href="viewassinged.php";
																</script>
													<?php
