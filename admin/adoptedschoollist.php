...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Adopted School : TWTAMP </title>
...
tinyMCE.init({
        ...
        <body class="nav-md">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <a href="../adoptedschool/"><h2>नये गोद लिये स्कूल की जानकारी भरने के लिये यहाँ क्लिक करें </h2></a>
					<hr/>
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					  ...
					  <?php  
								...
								$i = 0;	
								$b = mysqli_query("select * from membership where adopt=1");
					  ...
					  ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo ++$i; ?></td>
                          <td><?php echo $bb["tname"] ?></td>
                          <td><?php echo $bb["tmobile"] ?></td>
                          <td><?php echo $bb["adoptedschool"] ?></td>
                          <td><?php echo $bb["workprofile"] ?></td>
                                             </tr>
