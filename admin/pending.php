...
if (isset($_SESSION["id"])) {
    ...
    <html lang="en">
        <head>
            ...
            <title>Pending Member : TWTAMP </title>
                  ...
                  <div class="x_content">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
					  ...
					  <?php  
								...
								$i = 0;	
								$b = mysqli_query("select * from membership where flag = 0");
					  ...
					  ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $bb["temail"] ?></td>
                          <td><?php echo $mem ?></td>
                          <td><?php echo $bb["tdist"] ?></td>
                          <td><a style="color:orangered; font-weight:bold;" href="pending.php?wid=<?php echo $bb["wid"]?>">Approve</a></td>
                        </tr>
